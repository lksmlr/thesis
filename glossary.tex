...
\newglossaryentry{OpenAI Message Format}{
    ...
    description={Das \textbf{OpenAI Message Format} ist ein standardisiertes, rollenbasiertes Datenformat zur Interaktion mit Modellen, bei dem Nachrichten nach Rollen (z. B. \texttt{user}, \texttt{assistant}) unterteilt und Inhalte als Array aus verschiedenen Typen wie Text und Bild definiert werden.}
}
