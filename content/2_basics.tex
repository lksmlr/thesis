...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \label{fig:kg5bpage2}
    \end{subfigure}
    \caption{Exemplarisch ausgefülltes KG5b-Formular mit Markierung der relevanten Felder}
    \label{fig:kg5b}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption{Synthetischer Ausbildungsvertrag der Industrie- und Handelskammer mit markierten Datenfeldern}
    \label{fig:vertrag}
\end{figure}
