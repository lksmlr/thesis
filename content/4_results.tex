...
\section{Ergebnisse der OCR/YOLO-Pipeline gegenüber der Basismodelle}\label{sec:results_ie}

Die Evaluation der \gls{IE} in Abbildung~\ref{fig:results_ie} zeigt deutliche Unterschiede zwischen den modernen \glspl{VLM} und der OCR/YOLO-Pipeline.

Schwächen der OCR/YOLO-Pipeline zeigten sich bei der Verarbeitung von Ausbildungsverträgen.
Hier erreichte die Pipeline einen F1-Score von 0,51.
Im Vergleich schnitten insbesondere die beiden Qwen-Modelle besser ab.
...
Im Gegensatz dazu erkennt die OCR/YOLO-Pipeline die sonstigen Dokumente perfekt, klassifiziert aber einige der Verträge und KG5b-Formulare als sonstige Dokumente.
...
Die OCR/YOLO-Pipeline antwortet mit einer durchschnittlichen \gls{Latenz} von 0,58 Sekunden nahezu sofort.
...
Der Energieverbrauch in Abbildung~\ref{fig:results_energy_usage} zeigt den markantesten Unterschied zwischen der OCR/YOLO-Pipeline und den \glspl{VLM}.
