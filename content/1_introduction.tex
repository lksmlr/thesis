...
Diese technische Fragmentierung und die daraus resultierende Fehleranfälligkeit der Prozesskette werden in der detaillierten Analyse des Ist-Zustands in Abschnitt\ref{subsec:current} aufgezeigt.
Die dort dargestellte Architektur verdeutlicht die Notwendigkeit eines einzigen Modells.
