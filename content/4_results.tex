...
Die folgenden Ergebnisse wurden mit dem Testdatensatz (siehe Abschnitt~\ref{subsec:test_val_dataset}) evaluiert.
...
Die Ergebnisse der~\gls{Information Extraction} zeigen die Abhängigkeit der Leistungsfähigkeit von der Dokumentenart bei der OCR/YOLO-Pipeline.
...
In der Kategorie der sonstigen Dokumente fällt die Leistung aller Modelle gegenüber den anderen Dokumentenarten ab.
