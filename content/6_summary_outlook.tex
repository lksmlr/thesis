...
Die vorliegende Bachelorarbeit untersuchte das Potenzial von multimodalen Large Language Models als Nachfolger für die bestehende YOLO/OCR-Pipeline zur Verarbeitung von Ausbildungsnachweisen von volljährigen Auszubildenden.
...
Die Ergebnisse zeigen deutlich, dass die herkömmliche \gls{YOLO}/\gls{OCR}-Pipeline bei heterogenen Ausbildungsverträgen an ihre Grenzen stößt (F1-Score von 0,51).
Die \glspl{VLM} konnten hier eine signifikante Leistungssteigerung erzielen.
