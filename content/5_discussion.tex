...
Fotos weisen häufig Verzerrungen, Schattenwurf oder eine schlechte Beleuchtung auf, wodurch die \gls{OCR}-Ergebnisse des vorgeschalteten Systems schlechter ausfallen und die Klassifikation erschweren.
...
Methodische Limitationen zeigten sich in der Robustheit der Klassifikation bei Fehlklassifikationen.
...
Damit ließe sich nicht nur die Generierung invalider \gls{JSON}-Schemata verhindern, sondern auch das Format für Datumsangaben und binäre Felder festlegen.
...
Hierfür müsste eine Anpassung der Trainingsdaten mittels Augmentation erfolgen, da für diese vermischten Dokumente nur wenig Trainingsdaten zur Verfügung stehen.
...
Für den Fall derartig vielseitiger Dokumente muss für den produktiven Einsatz eine Strategie, wie beispielsweise eine Vorfilterung, entwickelt werden.
