...
Auch in der Bundesagentur für Arbeit (BA) macht sich dieser Wandel hin zu mehr Digitalisierung bemerkbar.
...
Das System klassifiziert die Dokumente, erkennt mithilfe von \gls{YOLO}- und \gls{OCR}-Modellen Inhalte aus hochgeladenen Dokumenten und zeigt dem Sachbearbeiter entsprechende Vorschläge an.
Diese aktuelle OCR/YOLO-Pipeline wertet die Bearbeitung der Kindergeldanträge für die Sachbearbeiter bereits auf, stößt jedoch an ihre Grenzen.
...
Dieser Prozess, auch Medienbruch genannt, hat eine schlechte Qualität zur Folge.

Angesichts der Verwendung von vielen unterschiedlichen Modellen ist die Wartung des Systems aufwendig.
...
Angesichts der hohen Anzahl manuell bearbeiteter Anträge soll untersucht werden, inwieweit VLMs diesen Prozess effizienter gestalten können.

Die Arbeit umfasst die Implementierung einer Pipeline, die gescannte Dokumente als Bilddaten verarbeitet.
