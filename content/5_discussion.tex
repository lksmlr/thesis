...
Die Skalierung fällt hier wesentlich schwerer als die der deterministischen YOLO/OCR-Pipeline, da mit gewünschter Latenz und gewünschten gleichzeitigen Anfragen die Entscheidung der benötigten Hardware gefällt werden muss.


\section{Limitation und Probleme der Untersuchung}\label{sec:limitations}

- merging der adapter weights deswegen höherer verbrauch -> isngesatm 11 traininglsäufe = 11 Modell = viel speicher
...
- ram overflow Pixtral framework
- mehrere dokumentenarten in einem dokument -> nur 32B bei 3/3 Fällen erkannt. sonst nur finetuned modell, aber hier zu wenig trainingsdaten -> augmentation



\section{Handlungsempfehlung für die Bundesagentur für Arbeit}\label{sec:recommendation_for_action}

Aus der Beantwortung der Forschungsfragen leitet sich die Handlungsempfehlung für die Bundesagentur für Arbeit ab.
...
- dynmaische vram näher betrachten
- 32B Modell könnten mehrere benutzen
